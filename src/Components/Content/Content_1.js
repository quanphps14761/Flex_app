                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-lg-6">
                            <div className="image-content aos-init aos-animate" data-aos="fade-right">
                                <img className="img-fluid" src="https://demo.themefisher.com/small-apps-hugo/images/feature/feature-new-01.webp" onerror="this.onerror=null;this.src='http:\/\/demo.themefisher.com\/small-apps-hugo\/images\/feature\/feature-new-01.jpg'" alt="feature image" />
                            </div>
                        </div>
                        <div className="col-lg-6">
